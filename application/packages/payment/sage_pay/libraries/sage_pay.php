 ...
 * 
 *
 * @package       Sage Pay payment module
 * @subpackage    
 * @category      Packages/Payment
 * @author        swicks@devicesoftware.com
 * @version       0.2
 * @todo          integrate backend to manage payments directly , support form, server & 3D secure, 
 */
...
class Sage_pay {
    ...
    public function process_payment() {
        ...
        $sp_data = $this->CI->session->userdata('sp_data');
        $customer = $this->CI->mp_cart->customer();

        // Set our sagepay fields       

        $this->CI->sage_pay_lib->add_field('Amount', $this->CI->mp_cart->total());
