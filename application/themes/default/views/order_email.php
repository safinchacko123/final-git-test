	...
	<table cellpadding="5" cellspacing="5" border="0">
		...
		<tfoot>
        	...
        	<tr>
				...
				<td colspan="3"><?php echo format_currency(0-$this->mp_cart->group_discount()); ?></td>
			</tr>
			<?php endif; ?>
			...
			<tr>
				...
				<td colspan="3">
					<?php echo format_currency($this->mp_cart->subtotal()); ?>
				</td>
			</tr>
			<tr>
		...
		<?php if($this->mp_cart->coupon_discount() > 0)  :?> 
			<tr>
				...
				<td colspan="3"><?php echo format_currency(0-$this->mp_cart->coupon_discount()); ?>                </td>
			</tr>
			...
			<tr>
				...
				<td colspan="3"><?php echo format_currency($this->mp_cart->discounted_subtotal(), 2, '.', ','); ?>                </td>
			</tr>
...
?>
           <?php if($this->mp_cart->order_tax() != 0) : ?> 
         	<tr>
				<td colspan="3"><?php echo lang('taxes');?></td>

				<td colspan="3"><?php echo format_currency($this->mp_cart->order_tax()); ?>                </td>
			</tr>
          <?php endif;   ?>

           <?php if($this->mp_cart->gift_card_discount() != 0) : ?> 
         	<tr>
				<td colspan="3"><?php echo lang('gift_card');?></td>

				<td colspan="3"><?php echo format_currency($this->mp_cart->gift_card_discount()); ?>                </td>
			</tr>
          <?php endif;   ?>
            <tr> 
				<td colspan="3">
				...
				<td colspan="3">
					<?php echo format_currency($this->mp_cart->total()); ?>
				</td>
			</tr>
		</tfoot>
		<tbody>
