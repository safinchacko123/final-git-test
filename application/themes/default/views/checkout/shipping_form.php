...
<?php echo form_open('checkout/step_2');?>
	<div class="row">
		...
		<div class="span6">
			...
			<?php echo form_textarea(array('name'=>'shipping_notes', 'value'=>set_value('shipping_notes', $this->mp_cart->get_additional_detail('shipping_notes')), 'class'=>'span6', 'style'=>'height:75px;'));?>
		</div>
	</div>
