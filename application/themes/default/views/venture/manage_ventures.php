        ...
        <fieldset>
            ...
            <div class="tabbable">
                <ul data-tabs="tabs" class="nav nav-tabs">
                    ...
                    <li>
                        <a id="lnkPass" href="<?php echo site_url('secure/my_account'); ?>" class="clsTab">Change password</a>
                    </li>
                    <li class="active">
                ...
                <div>
                    <div class="span7" id='venture_list' style="height: 540px;">
                        <?php if (count($ventures) > 0): ?>
                            <table class="table table-bordered table-striped width_100percent float-left">
                                <?php
                                $c = 1;
