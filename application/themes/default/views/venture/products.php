...
<div class="row">
    <div class="span12" style="border-bottom:1px solid #f5f5f5;">
        <div class="row">
            ...
            <div class="span8">
                <?php echo form_open(base_url() . 'venture/products', 'class="form-inline" style="float:right"'); ?>
                <fieldset>
                    <?php
...
<?php echo form_open(base_url() . '/products/bulk_save', array('id' => 'bulk_form')); ?>
<table class="table table-striped">
    <thead>
        <tr>
<!--            <th>
            <?php echo sort_url('sku', 'sku', $order_by, $sort_order, $code, $this->config->item('admin_folder')); ?>
            </th>-->
    ...
    <tbody>
        ...
        <?php foreach ($products as $product): ?>
            <tr>
                ...
                <td>
                    <span class="btn-group pull-right">
                        <a class="btn" href="<?php echo site_url($this->config->item('admin_folder') . '/products/review/' . $product->id); ?>">View Reviews</a>
