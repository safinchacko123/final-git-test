<?php if ($this->mp_cart->total_items()==0):?>
    ...
    <div class="row summaryBottom">
        ...
        <div class="span10" style="text-align:right;">
            ...
            <?php if ($this->Customer_model->is_logged_in(false,false) || !$this->config->item('require_login')): ?>
                <input class="btn btn-medium btn-primary" type="submit" onclick="$('#redirect_path').val('checkout');" value="<?php echo lang('form_checkout');?>"/>
            <?php endif; ?>
