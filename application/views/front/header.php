...
<div class="container-fluid header">
    ...
    <div class="col-md-4 col-sm-12">
      ...
      <div id="navbar" class="navbar-collapse collapse navbar-right">
		...
		<?php if( $currentMethod != 'detail') { ?>
          <li  class="cart cartManu-li" ><a class="btn-topCartIcon" id="dLabel" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#;"><i class="icon"><img src="<?php echo site_url(); ?>assets/front/images/cart-icon-new.png" /></i><span id="topCartIconCount"><?php echo $this->cart->total_items(); ?></span> item</a>
          <div class="dropdown-menu area_cartBox" aria-labelledby="dLabel">
