...
<link href="<?php echo site_url(); ?>assets/front/css/responsive.css" rel="stylesheet" type="text/css"/>
...
<body>
<!-- Loading div -->
    <div style="display:none" id="mainLoadingdiv" class="mainLoadigArea">
...
<header class="container-fluid">
  <div class="container">
    <div class="row">
      <div class="logo"> <img  src="<?php echo site_url(); ?>assets/front/images/logo.png"> </div>
    </div>
  </div>
</header>
