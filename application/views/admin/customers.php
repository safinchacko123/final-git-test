...
<table class="table table-striped">
   ...
   <th>
                            <a href="<?php echo site_url($this->config->item('admin_folder').'/customers/index/active/');?>/<?php echo ($field == 'active')?$by:'';?>"><?php echo lang('active');?>    
                            <?php if($field == 'active'){ echo ($by == 'ASC')?'<i class="icon-chevron-down"></i>':'<i class="icon-chevron-up"></i>';} ?>
                            </a>
                        </th>
                        <th>
                            <a href="<?php echo site_url($this->config->item('admin_folder').'/customers/index/created_on/');?>/<?php echo ($field == 'created_on')?$by:'';?>"><?php echo lang('created_on');?>  
   ...
   <th></th>
	...
	<tbody>
		...
		if($page_links != ''):?>
		<tr><td colspan="6" style="text-align:center"><?php echo $page_links;?></td></tr>
		<?php endif;?>
