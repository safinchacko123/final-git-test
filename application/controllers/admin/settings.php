...
//        }
        ...
        //Settings page modified by satheesh
        $data['page_title']     = lang('common_settings');
        $settingdata            = $this->Settings_model->get_settings('admin_settings');
        $data['invoice_date']   = $settingdata['monthly_invoice_date'];
        ...
        if ($this->form_validation->run() == FALSE)
        {
            ...
            $save['monthly_invoice_date'] = $this->input->post('invoice_date');
            $this->Settings_model->save_settings('admin_settings', $save);
            
            $this->session->set_flashdata('message', lang('settings_saved_message'));
