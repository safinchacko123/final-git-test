...
//store dimensions in inches//
	...
	function getArea_byLocation($latitude,$longitude,$categoty_id='',$limit='', $offset='0')
	{
		//~ $latitude = $_COOKIE['location_hid_lat'];
		//~ $longitude = $_COOKIE['location_hid_lng'];
		//~ $country_id = $_COOKIE['location_hid_country_id'];		
		//~ 
	...
	function getSearchResult($get=array(),$ventureIds=array(),$ventureNames=array(),$limit=5,$offset=1,$countStatus=0)	
	{
		...
		if(isset($get['deliveryFee_list']) && !empty($get['deliveryFee_list']))
		{
			...
			$filterChecksHTML[] = $this->callbackSearchPageFilterLink('Delivery fee: '.$get['deliveryFee_list'],'deliveryFee_list',$get['deliveryFee_list']);	
		}
		...
		if(isset($get['paymentMethod_list']) && !empty($get['paymentMethod_list']))
		{
			...
			$filterChecksHTML[] = $this->callbackSearchPageFilterLink('Payment Method : '.$get['paymentMethod_list'],'paymentMethod_list',$get['paymentMethod_list']);	
		}
