...
Class Customer_model extends CI_Model {
    ...
    function delete($id) {
        ...
        //this deletes the venture timings record
        $this->db->where('venture_id', $id);
        $this->db->delete('venture_timing');

        //this deletes the venture-cuisine record
        $this->db->where('venture_id', $id);
        $this->db->delete('venture_cuisine_map');
...
//            $this->email->message('Your password has been reset to <strong>' . $new_password . '</strong>.');
	...
	/* By Lynn 13 May */
         function is_invoice_user($order_id) {
        if ($this->customer['access'] == '') {
            return TRUE;
        } else if ($this->customer['access'] == 'Venture') {
            $this->db->select('venture_id');
            $this->db->from('orders');
            $this->db->where('venture_id', $this->customer['id']);
